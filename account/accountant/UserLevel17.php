        ...
        <div id="navbar" class="navbar-collapse collapse" aria-expanded="false">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown" id="menuDrop">
                    ...
                    <li><a href="order.php" target="_blank"><?= (defined('ADD_NEW_ORDER')) ? ADD_NEW_ORDER : 'ADD_NEW_ORDER'; ?></a></li>
            <?php endif; ?>
                </li>
            </ul>
        </div>
    ...
    <form  method="POST" action="" >
        <input type="hidden" name="posting" value="filter">
            <table style="width: 100%" class="table table-bordered table-hover">
             ...
             <input type="hidden" name="currencies" value="AMD"> 
        ...
        <div style="bottom:0; width: 100%">
                  ...
                  <table style="width: 100%" class="table table-bordered table-hover">
                   ...
                   <table style="width: 100%" class="table table-bordered table-hover">
                       ...
                       <input id="selectedcurrency" name="selectedcurrency" type="hidden" value="AMD"> 
                </table>              
        </div>    
